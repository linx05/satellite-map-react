...
function* fetchLatestPosition() {
  ...
  const response = yield call(
    SatelliteAPI.getPositions.bind(SatelliteAPI),
    userLocation
  );
...
// Listeners
export default [
  takeLatest(FETCH_SATELLITE_LOCATION, fetchLatestPosition),
  takeLatest(START_POLLING_SATELLITE_LOCATION, handlePolling)
];
